...
const s = StyleSheet.create({
  ...
  catBtn: { paddingHorizontal: 14, paddingVertical: 7, borderRadius: 18, backgroundColor: CARD, borderWidth: 1, borderColor: BORDER, minHeight: 34, alignItems: 'center', justifyContent: 'center' },
  catBtnActive: { backgroundColor: PRIMARY, borderColor: PRIMARY },
  catBtnText: { fontSize: 13, color: GRAY, fontWeight: '500', includeFontPadding: false, lineHeight: 16 },

              ...
              <View style={s.detailBody}>
                ...
                {!isOwner && (
                  <>
                    ...
                    <TouchableOpacity style={s.actionCardBtn} onPress={() => openDMWithSeller(selectedListing)}>
                      <Text style={s.actionCardEmoji}>💬</Text>
                      <View>
                        <Text style={s.actionCardTitle}>Message seller on Tryber</Text>
                        <Text style={s.actionCardSub}>Chat directly in the app</Text>
                      </View>
                    </TouchableOpacity>
                      ...
                      myOffers.map(offer => (
                        <View key={offer.id} style={s.offerCard}>
                          ...
                          {offer.status === 'countered' && offer.counter_amount && (
                            <>
                              <Text style={[s.offerStatus, { color: '#FF6B35' }]}>Seller countered: {formatPrice(offer.counter_amount)}</Text>
                        ...
                        {offer.status === 'pending' && (
                          <>
                            {showCounter === offer.id ? (
                              <View style={s.offerInputRow}>
                                <TextInput style={s.offerInput} value={counterAmount} onChangeText={setCounterAmount} placeholder="Counter offer..." placeholderTextColor="#B4B2A9" keyboardType="numeric" autoFocus />
                              ...
                              <View style={s.offerActions}>
                                ...
                                <TouchableOpacity style={[s.offerAcceptBtn, { backgroundColor: '#FF6B35' }]} onPress={() => setShowCounter(offer.id)}>
        ...
        <View style={[s.addContainer, { paddingTop: insets.top }]}>
          <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
            ...
            <ScrollView contentContainerStyle={s.addForm} keyboardShouldPersistTaps="handled">
              ...
              <Text style={s.formLabel}>PRICE IN ₪ *</Text>
...
const s = StyleSheet.create({
  ...
  emptyTitle: { fontSize: 20, fontWeight: '700', color: '#2C2C2A', marginBottom: 20 },
  ...
  actionCardBtn: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: '#E1F5EE', borderRadius: 14, padding: 14, marginBottom: 8 },
  actionCardEmoji: { fontSize: 28 },
  actionCardTitle: { fontSize: 14, fontWeight: '600', color: '#2C2C2A' },
  actionCardSub: { fontSize: 12, color: GRAY },
  offerCard: { backgroundColor: '#F1EFE8', borderRadius: 14, padding: 14, marginBottom: 8 },
  offerText: { fontSize: 15, fontWeight: '600', color: '#2C2C2A', marginBottom: 6 },
  offerStatus: { fontSize: 13, color: GRAY },
  offerActions: { flexDirection: 'row', gap: 8, marginTop: 10 },
  offerAcceptBtn: { flex: 1, backgroundColor: GREEN, paddingVertical: 10, borderRadius: 10, alignItems: 'center' },
  offerAcceptText: { color: '#fff', fontWeight: '700', fontSize: 13 },
  offerRejectBtn: { flex: 1, backgroundColor: '#F1EFE8', paddingVertical: 10, borderRadius: 10, alignItems: 'center', borderWidth: 1, borderColor: '#E0DED8' },
  offerRejectText: { color: GRAY, fontWeight: '600', fontSize: 13 },
  makeOfferBtn: { backgroundColor: '#EEEDFE', borderRadius: 14, padding: 14, alignItems: 'center' },
  makeOfferText: { fontSize: 15, fontWeight: '600', color: '#7F77DD' },
  offerInputRow: { flexDirection: 'row', gap: 8, alignItems: 'center' },
  offerInput: { flex: 1, backgroundColor: '#fff', borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12, fontSize: 15, color: '#2C2C2A', borderWidth: 1, borderColor: '#E0DED8' },
  offerSendBtn: { backgroundColor: GREEN, paddingHorizontal: 16, paddingVertical: 12, borderRadius: 12 },
  ...
  payBtnText: { fontSize: 13, fontWeight: '600', color: '#2C2C2A' },
  deliveryBtn: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: '#F1EFE8', borderRadius: 14, padding: 14, marginBottom: 8 },
